...
namespace CodeDocumentor.Test
{
    ...
    public abstract partial class DiagnosticVerifier
    {
        ...
        /// </summary>
        protected virtual DiagnosticAnalyzer GetCSharpDiagnosticAnalyzer(string diagType)
        {
            return null;
        }
        ...
        protected async Task VerifyCSharpDiagnosticAsync(string source, string diagType = "public", params DiagnosticResult[] expected)
        {
            await VerifyDiagnosticsAsync(new[] { source }, LanguageNames.CSharp, GetCSharpDiagnosticAnalyzer(diagType), expected);
        }
        ...
        protected async Task VerifyCSharpDiagnosticAsync(string[] sources, string diagType = "public", params DiagnosticResult[] expected)
        {
            await VerifyDiagnosticsAsync(sources, LanguageNames.CSharp, GetCSharpDiagnosticAnalyzer(diagType), expected);
        }
        ...
        /// <summary>
        ///   Checks each of the actual Diagnostics found and compares them with the corresponding DiagnosticResult in
        ///   the array of expected results. Diagnostics are considered equal only if the DiagnosticResultLocation, Id,
        ...
        /// <summary>
        ///   Helper method to VerifyDiagnosticResult that checks the location of a diagnostic and compares it with the
        ///   location in the expected DiagnosticResult.
        /// </summary>
        /// <param name="analyzer"> The analyzer that was being run on the sources </param>
        ...
        private static void VerifyDiagnosticLocation(DiagnosticAnalyzer analyzer, Diagnostic diagnostic, Location actual, DiagnosticResultLocation expected)
        {
            ...
            Assert.True(actualSpan.Path == expected.Path || (actualSpan.Path?.Contains("Test0.") == true && expected.Path.Contains("Test.")),
