...
{
    public class OperatorAnalyzerSettings : BaseAnalyzerSettings
    {
        public const string DiagnosticId = Constants.DiagnosticIds.OPERATOR_DIAGNOSTIC_ID;
        public const string MessageFormat = Title;
        public const string Title = "The operator must have a documentation header.";
