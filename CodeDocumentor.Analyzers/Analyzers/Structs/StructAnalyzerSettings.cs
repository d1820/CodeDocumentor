...
{
    public class StructAnalyzerSettings : BaseAnalyzerSettings
    {
        public const string DiagnosticId = Constants.DiagnosticIds.STRUCT_DIAGNOSTIC_ID;
        public const string MessageFormat = Title;
        public const string Title = "The struct must have a documentation header.";
