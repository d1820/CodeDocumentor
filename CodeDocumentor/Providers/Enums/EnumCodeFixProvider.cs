...
namespace CodeDocumentor
{
    ...
    public class EnumCodeFixProvider : BaseCodeFixProvider
    {
        ...
        private Task<Document> AddDocumentationHeaderAsync(ISettings settings, Document document, SyntaxNode root, EnumDeclarationSyntax declarationSyntax, CancellationToken cancellationToken)
        {
