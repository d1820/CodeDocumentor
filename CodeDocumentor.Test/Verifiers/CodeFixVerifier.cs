...
namespace CodeDocumentor.Test
{
    ...
    public abstract partial class CodeFixVerifier : DiagnosticVerifier
    {
        ...
        /// <summary>
        ///   General verifier for codefixes. Creates a Document from the source string, then gets diagnostics on it and
        ///   applies the relevant codefixes. Then gets the string after the codefix is applied and compares it with the
        ///   expected result.
        ///   Note: If any codefix causes new diagnostics to show up, the test fails unless allowNewCompilerDiagnostics
        ///         is set to true.
        /// </summary>
